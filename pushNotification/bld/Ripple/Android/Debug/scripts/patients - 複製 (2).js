...
function showList(listID,sickNo, name, pregistContext, pregistDate) {
    ...
    listID.append('<li><a href="#patientPage" data-role="button"  data-rel="dialog" onclick=' + setSickNoVal + '  data-transition="slide" > <img src="images/money.jpg" class="ui-li-icon" ><h3>' + name + ' 【 ' + pregistDate + ' 】 </h3><p>' + pregistContext + '</p> </a> </li>').listview('refresh');
}
    ...
    $.ajax({
        ...
        success: function (data) {
            $(data).each(function (index, obj) {
                ...
                $("#opasmDIV").append("<div><font color='#00FF00'>就診日期：" + visitedDate + "</font></div>");
